...
// Quiz Answer
router.post("/submitAnswer", verifyInstituteToken, isInstitute, submitQuizAnswer);
router.get("/quizResult", verifyInstituteToken, isInstitute, quizResultForAttempter);
